...
$(document).ready(function() {
    ...
    $('.back_chatBoxone').on('click', function() {
        var my_val = $('.pcoded').attr('vertical-placement');
        if (my_val == 'left') {
            var options = {
                direction: 'right'
    ...
    $('#mobile-collapse i').addClass('icon-chevron-right');
    // $(".pcoded-navbar").attr("dir", "rtl");
    $('#mobile-collapse').on('click', function() {
        var x = document.getElementById("f_text");
        if (x.innerHTML === "F") {
          x.innerHTML = "FitOS";
          x.style.fontSize='28px'; 
          $(".pcoded-navbar").attr("dir", "ltr");
          $("#mobile-collapse").css("left","4px");
          $('#mobile-collapse i').css('z-index','99999999999999');
        } else {
          x.innerHTML = "F";
          x.style.fontSize='18px';
          $(".pcoded-navbar").attr("dir", "rtl");
          $("#mobile-collapse").css("left","22px");
        }
        $("#dash").toggleClass('pcoded-trigger');
        $('#mobile-collapse i').toggleClass('icon-chevron-right');
        $('#mobile-collapse i').toggleClass('icon-chevron-left');
        $('#mobile-collapse i').css('z-index','99999999999999');
...
$('#styleSelector').append('' +
    ...
    '<ul>' +
        '<li>' +
            '<a href="https://themeforest.net/user/phoenixcoded" class="btn btn-success btn-block m-r-15 m-t-10 m-b-10 waves-effect waves-light">Profile</a>' +
