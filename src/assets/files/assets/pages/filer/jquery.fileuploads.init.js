...
$(document).ready(function(){
	...
	//Example 1
    $("#filer_input1,#filer_input2,#filer_input3,#filer_input4,#filer_input5,#filer_input6,#filer_input7,#filer_input8,#filer_input9,#filer_input10,#filer_input11,#filer_input12").filer({
        limit: null,
        maxSize: null,
        extensions: null,
